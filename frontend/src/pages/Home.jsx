...
function Home() {
  ...
  // Busca o total de garrafas ao carregar a página
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      {/* Adicionando a animação de flutuar (ondas) */}
      <style>{`
        @keyframes float {
      ...
      <section className="min-h-[85vh] w-full relative bg-gradient-to-b from-blue-300 via-blue-400 to-blue-600 flex flex-col items-center justify-center text-white overflow-hidden">
        ...
        {/* Contador com Animação de Flutuar */}
        <div className="z-30 text-center mt-10 animate-float">
          <h1 className="text-6xl md:text-8xl font-bold drop-shadow-lg font-hand">
            {bottleCount !== null ? bottleCount : "..."}
          </h1>
          <p className="text-xl md:text-2xl mt-4 font-light tracking-widest uppercase">
            Garrafas no Oceano
          </p>
        </div>

        {/* --- NOVOS COQUEIROS (Invadindo o céu) --- */}
        <img 
            src="/coconut-tree.png" 
            alt="Coqueiro Grande Esquerda" 
            className="absolute bottom-[-60px] left-[-60px] w-96 md:w-[600px] opacity-100 z-20 pointer-events-none transform -rotate-6" 
        />
        <img 
            src="/coconut-tree.png" 
            alt="Coqueiro Grande Direita" 
            className="absolute bottom-[-40px] right-[-40px] w-72 md:w-96 opacity-100 z-20 pointer-events-none transform scale-x-[-1] rotate-6" 
        />
      ...
      {/* SEÇÃO 2: Chamada para Ação (Areia Clara) */}
      <section className="min-h-[80vh] bg-[#F4A460] flex flex-col items-center justify-center p-8 relative z-10">
        ...
        <img 
            ...
            alt="Estrela Decorativa 1" 
            className="absolute bottom-10 right-0 w-64 md:w-80 opacity-90 hidden md:block z-0 pointer-events-none" 
        />
        <img 
            src="https://cdn-icons-png.flaticon.com/512/433/433539.png" 
            alt="Estrela Decorativa 2" 
            className="absolute bottom-[-20px] left-[-20px] w-40 md:w-56 opacity-80 scale-x-[-1] hidden md:block z-0 pointer-events-none" 
        />

        <h2 className="text-3xl md:text-5xl text-orange-900 font-bold mb-10 text-center max-w-2xl font-hand drop-shadow-sm z-10">
          Envie a sua mensagem para o mundo agora.
        </h2>

        <button 
          onClick={handleWriteMessage}
          className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-5 px-14 rounded-full text-2xl shadow-2xl transition transform hover:scale-105 hover:-translate-y-1 z-10 border-4 border-orange-400/30"
        >
          ESCREVER MENSAGEM
        </button>
      ...
      {/* SEÇÃO 3: O "FAQ" (Cards Limpos e Arredondados) */}
      <section className="bg-[#e8b67d] py-24 px-6 relative font-sans">
        <div className="max-w-6xl mx-auto mb-20 relative">
          ...
          <img 
              src="/crab.png" 
              alt="Caranguejo Decorativo Direita" 
              className="absolute top-[-50px] right-0 w-32 md:w-48 opacity-90 z-0 pointer-events-none transform rotate-12" 
          />

          {/* 2. Esquerda (Perto do Footer) */}
          <img 
              src="/crab.png" 
              alt="Caranguejo Decorativo Esquerda" 
              className="absolute bottom-[-100px] left-0 w-32 md:w-48 opacity-90 z-0 pointer-events-none transform -rotate-12 scale-x-[-1]" 
          />
          {/* ------------------- */}

          <h3 className="text-4xl text-center text-orange-950 font-hand font-bold mb-16 drop-shadow-sm relative z-10">
            O Código da Maré 📜
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative z-10">
            ...
            <div className="bg-[#fffdf0]/90 p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h4 className="text-2xl font-bold text-blue-900 mb-2 font-hand text-center">Você é um Ilhado</h4>
              <p className="text-gray-700 leading-relaxed text-center text-sm">
                Neste jogo, você é um náufrago digital. 
                Para participar, basta fazer seu <strong>cadastro ou login</strong>. 
            ...
            <div className="bg-[#fffdf0]/90 p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              <div className="text-5xl mb-4 text-center">✍️</div>
              <h4 className="text-2xl font-bold text-orange-800 mb-2 font-hand text-center">Uma Carta, Um Dia</h4>
              <p className="text-gray-700 leading-relaxed text-center text-sm">
                A escassez é valiosa. Você pode escrever e lançar 
                apenas <strong>uma mensagem por dia</strong>. 
            ...
            <div className="bg-[#fffdf0]/90 p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
              ...
              <h4 className="text-2xl font-bold text-teal-800 mb-2 font-hand text-center">O Horizonte</h4>
              <p className="text-gray-700 leading-relaxed text-center text-sm">
                Vê o número no céu? Ele conta as <strong>garrafas boiando</strong> agora. 
            ...
            <div className="bg-[#fffdf0]/90 p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 md:col-span-1.5">
              <div className="text-5xl mb-4 text-center">🌕</div>
              <h4 className="text-2xl font-bold text-indigo-900 mb-2 font-hand text-center">A Maré das 22h</h4>
              <p className="text-gray-700 leading-relaxed text-center text-sm">
                Todos os dias, às <strong>22:00 (BRT)</strong>, ocorre o grande sorteio. 
            ...
            <div className="bg-[#fffdf0]/90 p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 md:col-span-2">
              <div className="text-5xl mb-4 text-center">🐚</div>
              <h4 className="text-2xl font-bold text-yellow-800 mb-2 font-hand text-center">O Que a Maré Traz</h4>
              <p className="text-gray-700 leading-relaxed text-center text-sm">
                A regra de ouro: <strong>Você escreve para o mundo, mas lê o que recebe.</strong> Suas mensagens enviadas partem para sempre. 
          ...
          <div className="mt-20 text-center opacity-70 relative z-10">
             <p className="text-orange-950 text-xl font-hand italic leading-relaxed">
      ...
      <footer className="bg-[#c2966b] text-orange-900/80 py-10 px-4 text-center border-t border-orange-900/10 font-sans z-20 relative">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-6">
            ...
            <div className="flex items-center justify-center gap-8 mb-2">
                ...
                {/* GitHub */}
                <a href="https://github.com/gabrielclaudinoo" target="_blank" rel="noreferrer" className="transform hover:scale-110 transition duration-300" title="Meu GitHub">
                ...
                {/* Email */}
                <a href="mailto:gaclaudinoo@gmail.com" className="transform hover:scale-110 transition duration-300" title="Entre em contato">
            ...
            <div>
                <p className="font-bold font-hand text-lg">Gabriel Claudino</p>
