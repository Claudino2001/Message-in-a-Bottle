    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <section className="bg-[#e8b67d] py-24 px-6 relative font-sans">
        <div className="max-w-6xl mx-auto mb-20 relative">
          ...
          {/* POSIÇÃO DO CARANGUEJO AJUSTADA: Mudado de top-[-50px] para top-[-90px] */}
          <img 
              src="/crab.png" 
              alt="Caranguejo Decorativo Direita" 
              className="absolute top-[-150px] right-0 w-32 md:w-48 opacity-90 z-50 pointer-events-none transform rotate-12" 
          />
      ...
      {/* Footer mantido (código omitido para brevidade, mas deve ser mantido no arquivo final) */}
