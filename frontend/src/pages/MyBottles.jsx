  ...
  return (
    <div className="min-h-screen bg-[#F4A460] pt-24 px-4 pb-10 font-sans">
      ...
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl text-orange-900 font-hand font-bold mb-8 text-center drop-shadow-sm">
        ...
        {loading ? (
          ...
          <div className="text-center bg-orange-200/50 p-10 rounded-xl border-2 border-orange-300 border-dashed">
            <p className="text-2xl text-orange-800 font-hand">Nenhuma garrafa encontrada ainda.</p>
            <p className="mt-2 text-orange-900">Aguarde o sorteio das 22h!</p>
          </div>
        ) : (
          <>
            ...
            <div className="flex flex-col gap-4">
              {sortedBottles.map((bottle) => {
                ...
                return (
                  <div 
                    key={bottle.id} 
                    onClick={() => toggleExpansion(bottle.id)}
                    /* AQUI: Removido border-l-4 e alterado para rounded-2xl */
                    className={`
                      bg-[#fffdf0] p-5 rounded-2xl shadow-md cursor-pointer 
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-xl font-bold text-blue-900 font-hand">
                        {bottle.title}
                      </h3>
                    ...
                    <div className="relative">
                      <p className={`
                        text-gray-700 font-hand text-lg leading-relaxed
                      ...
                      {!isExpanded && (
                        <div className="absolute bottom-0 left-0 w-full h-6 bg-gradient-to-t from-[#fffdf0] to-transparent"></div>
                      )}
                    </div>

                    {isExpanded && (
                      <div className="mt-4 text-center text-sm text-blue-400 font-bold hover:underline">
                        Recolher carta
                      </div>
                    )}
                  </div>
